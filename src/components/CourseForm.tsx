    ...
    <DialogContent className="w-[95vw] sm:max-w-[800px] max-h-[90vh] overflow-y-auto p-4 sm:p-6">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="syllabus" className="text-sm font-medium">Ementa</Label>
            <Textarea
              id="syllabus"
              name="syllabus"
              ...
              rows={3}
              className="min-h-[120px] resize-y"
              placeholder="Digite a ementa do curso"
            />
          </div>
          <div className="space-y-2">
            <Label htmlFor="bibliography" className="text-sm font-medium">Bibliografia</Label>
            <Textarea
              id="bibliography"
              name="bibliography"
              ...
              rows={3}
              className="min-h-[120px] resize-y"
              placeholder="Digite a bibliografia do curso"
            />
          </div>
        </div>
